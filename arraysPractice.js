...
and an array full of numbers. Your job is to write a function named finder that will get a random number,
...
function addTen(numbers) {
  ...
  for (i = 0; i < numbers.length; i++) {
    doubleDigits.push(numbers[i] + 10);
  }
  return doubleDigits;
}
...
var user3 = {
    name: 'Jim Adkins',
    email: 'jimmyeatworld23@gmail.com',
    password: 'futures2004',
    username: 'jimmyadkins'
}
